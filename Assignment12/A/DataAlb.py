...
# imports
import numpy as np
from albumentations import Compose, RandomCrop, Normalize, Cutout,HorizontalFlip, PadIfNeeded, HueSaturationValue,ShiftScaleRotate,HorizontalFlip
...
class album_compose:
    def __init__(self):
        self.alb_transform = Compose([
            PadIfNeeded(min_height=64, min_width=64, border_mode=cv2.BORDER_CONSTANT, value=4, always_apply=False,
                        p=.50),
